...
function Dashboard() {
    ...
    const { userList, isLoading, error, isWebsite } = useSelector((state) => state.userReducer);
            ...
            <main className="container col-f f-center">
                <section className="container col-f full-width section-max">
                    <div className="container row-f f-wrap">
                        <div style={{flexBasis : '300px'}} className="container col-f f-1">
                            ...
                            {isLoading ? (
                                        ...
                                        <p style={{fontSize : '350%', fontWeight : 'bold'}}>{`${dataCount}`}</p>
                                    )}
                            </div>
                        </div>
                        <div style={{flexBasis : '340px'}} className="container col-f f-1">
